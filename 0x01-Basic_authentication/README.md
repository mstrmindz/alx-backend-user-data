...
In the industry, it is advisable not to implement your own Basic authentication system and use a module or framework that does it for you [like in Python-Flask: Flask-HTTPAuth](https://intranet.alxswe.com/rltoken/rpsPy0M3_FJuCLGNPUbmvg). However, for learning purposes, we will walk through each step of this mechanism to understand it by doing.
